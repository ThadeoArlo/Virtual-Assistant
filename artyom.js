...
(function (window) {'use strict';
    ...
    function Artyom() {
        ...
        /**
         * Force artyom to   listen even if is in continuos mode.
         *
        ...
        /**
         *  s the actual and pendings messages that artyom have to say.
         *
         ...
         * is executed.
         *
         * If artyom gets a first parameter the instance will be  ped.
         *
         * @private
         * @returns {undefined}
         */
         ...
         *
         * Just create an instance and start and   when you want
         *
